...
class ModelBase:
    ...
    def __init__(self, dir_model: Path, r4_path:Path, ftype: gguf.LlamaFileType, fname_out: Path, *, is_big_endian: bool = False,
        ...
        self.r4_path = r4_path # hadamard Matrix for R4 rotation
        self.ftype = ftype
    ...
    # Step1: torch tensors의 있는 weight tensor들을 load하기 전에 미리 R4 matrix를 미리 load한다

        r4_name = "online_r4.weight"
        r4_matrix = torch.load(self.r4_path) #r4 matrix를 load한다
        scale=(1/math.sqrt(r4_matrix.shape[0]))
        scaled_r4_matrix = r4_matrix * scale
        yield r4_name, scaled_r4_matrix
    ...
    def prepare_tensors(self):
        ...
        for name, data_torch in chain(self.generate_extra_tensors(), self.get_tensors()):
            ...
            # if name.endswith(("r4")): # r4로 끝나는 Matrix에 관한 정보들
            ...
            for new_name, data_torch in (self.modify_tensors(data_torch, name, bid)):
                ...
                if n_dims <= 1 or new_name.endswith("_norm.weight") or "online" in new_name:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "r4_hadamard",
        type=Path,
        help="address of file containing R4 Hadamard Matrix",
    )
    parser.add_argument(
...
def main() -> None:
    ...
    with torch.inference_mode():
        ...
        model_instance = model_class(dir_model, r4_path,output_type, fname_out,
